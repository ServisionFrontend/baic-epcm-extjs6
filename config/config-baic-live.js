var config = {
  ...
  devServerMap: {},
  localServerUrlMap: {
    index: 'https://epcm.epc.baicmotor.com'
  },
  partnerApp: {
    epcServer: {
      host: '127.0.0.1',
  ...
  epcLoginUrl: 'https://epc.baicmotor.com/login',
  epcIndexUrl: 'https://epc.baicmotor.com/epc/catalog',
  epcSessionLocked: 'https://epc.baicmotor.com/error/sessionLocked'
};
