Ext.define('Ext.ux.component.grid.Selector', {
  ...
  getParams: function () {
    ...
    if (me.searchInputConfig.toUppercase) {
      keyWord = Ext.util.Format.uppercase(keyWord);
    }
  ...
  setConfig: function (config) {
    ...
    Ext.apply(me.searchInputConfig, config.searchInputConfig, me.searchInputConfig);
