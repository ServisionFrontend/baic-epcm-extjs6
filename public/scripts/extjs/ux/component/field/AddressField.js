    ...
    getProvinceItem: function() {
        var me = this,
            item = {
                action: 'province',
                title: ' 省 份 ',
                url: APP.globalConfig.restpath + '/base-data/country/province',
                listeners: {
    ...
    getCityItem: function() {
        var me = this,
            item = {
                action: 'city',
                title: ' 城 市 ',
                url: APP.globalConfig.restpath + '/base-data/country/province/{0}/city',
                listeners: {
                    afterrender: function() {
                        var that = this;
                        that.mon(
    ...
    getAreaItem: function() {
        var me = this,
            item = {
                action: 'area',
                title: ' 县 区 ',
                url: APP.globalConfig.restpath + '/base-data/country/province/city/{0}/area',
                listeners: {
                    afterrender: function() {
                        var that = this;
                        that.mon(
