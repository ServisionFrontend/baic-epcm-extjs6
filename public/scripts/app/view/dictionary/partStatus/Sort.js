Ext.define('APP.view.dictionary.partStatus.Sort', {
  ...
  getGridData: function (code) {
    ...
    Ext.util.ajax({
      url: APP.globalConfig.restpath + '/selector/list/part-status' + '?_dc=' + Math.random(),
      method: 'GET',
  ...
  saveSort: function () {
    ...
    if (data) {
      Ext.util.ajax({
        url: APP.globalConfig.restpath + '/sort/index/part-status',
        method: 'PUT',
        jsonData: data,
        beforerequest: function () {
          me.setLoading('加载中,请稍候...');
