Ext.define('APP.view.language.data.Grid', {
  extend: 'APP.view.common.grid.Grid',
  alias: 'widget.datagrid',
  store: 'APP.store.language.Data',
  rownumberer: true,
  controlButtons: [],
  tbar: [{
    xtype: 'button',
    ...
    hidden: !APP.permissionConfig.hasOperation('epcm:language:data:export')
  }, '-', {
    xtype: 'button',
    text: '导入翻译',
    ...
    hidden: !APP.permissionConfig.hasOperation('epcm:language:data:import')
  }],
  columns: [{
    text: '品牌编码',
    dataIndex: 'code',
