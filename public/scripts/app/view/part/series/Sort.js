Ext.define('APP.view.part.series.Sort', {
  ...
  getGridData: function (code) {
    ...
    Ext.util.ajax({
      url: APP.globalConfig.restpath + '/selector/list/series?brandCode=' + code  + '&_dc=' + Math.random(),
      method: 'GET',
  ...
  saveSort: function () {
    ...
    if (data) {
      Ext.util.ajax({
        url: APP.globalConfig.restpath + '/sort/index/series',
        method: 'PUT',
        jsonData: data,
        beforerequest: function () {
          me.setLoading('加载中,请稍候...');
