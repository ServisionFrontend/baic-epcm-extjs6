Ext.define('APP.view.part.subGroup.Sort', {
  ...
  getGridData: function (code) {
    ...
    Ext.util.ajax({
      url: APP.globalConfig.restpath + '/selector/list/sub-group?groupCode=' + code + '&_dc=' + Math.random(),
      method: 'GET',
      noCache: true,
  ...
  saveSort: function () {
    ...
    if (data) {
      Ext.util.ajax({
        url: APP.globalConfig.restpath + '/sort/index/sub-group',
        method: 'PUT',
        noCache: true,
        jsonData: data,
        beforerequest: function () {
